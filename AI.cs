...
public class AI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if we are in the 90% luck, we just add 2° per frame, it will be efficient with the Quaternion.Euler
        //if we are in the 10% luck, we just remove 2° per frame, it will be efficient with the Quaternion.Euler
